...
type AccountClient interface {
	...
	ListWithIds(ctx context.Context, in *ListWithIdsRequest, opts ...grpc.CallOption) (*ListWithIdsReply, error)
	EmailLogin(ctx context.Context, in *EmailLoginRequest, opts ...grpc.CallOption) (*AccountLoginReply, error)
}
...
func (c *accountClient) CreateAccount(ctx context.Context, in *CreateAccountRequest, opts ...grpc.CallOption) (*CreateAccountReply, error) {
	...
	err := c.cc.Invoke(ctx, "/account.service.v1.Account/CreateAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountClient) UpdateAccount(ctx context.Context, in *UpdateAccountRequest, opts ...grpc.CallOption) (*UpdateAccountReply, error) {
	...
	err := c.cc.Invoke(ctx, "/account.service.v1.Account/UpdateAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountClient) DeleteAccount(ctx context.Context, in *DeleteAccountRequest, opts ...grpc.CallOption) (*DeleteAccountReply, error) {
	...
	err := c.cc.Invoke(ctx, "/account.service.v1.Account/DeleteAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountClient) GetAccount(ctx context.Context, in *GetAccountRequest, opts ...grpc.CallOption) (*GetAccountReply, error) {
	...
	err := c.cc.Invoke(ctx, "/account.service.v1.Account/GetAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountClient) ListAccount(ctx context.Context, in *ListAccountRequest, opts ...grpc.CallOption) (*ListAccountReply, error) {
	...
	err := c.cc.Invoke(ctx, "/account.service.v1.Account/ListAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountClient) ListWithIds(ctx context.Context, in *ListWithIdsRequest, opts ...grpc.CallOption) (*ListWithIdsReply, error) {
	out := new(ListWithIdsReply)
	err := c.cc.Invoke(ctx, "/account.service.v1.Account/ListWithIds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountClient) EmailLogin(ctx context.Context, in *EmailLoginRequest, opts ...grpc.CallOption) (*AccountLoginReply, error) {
	out := new(AccountLoginReply)
	err := c.cc.Invoke(ctx, "/account.service.v1.Account/EmailLogin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAccountServer) ListWithIds(context.Context, *ListWithIdsRequest) (*ListWithIdsReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListWithIds not implemented")
}
func (UnimplementedAccountServer) EmailLogin(context.Context, *EmailLoginRequest) (*AccountLoginReply, error) {
...
func _Account_CreateAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/account.service.v1.Account/CreateAccount",
	}
...
func _Account_UpdateAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/account.service.v1.Account/UpdateAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Account_DeleteAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/account.service.v1.Account/DeleteAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Account_GetAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/account.service.v1.Account/GetAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Account_ListAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/account.service.v1.Account/ListAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Account_ListWithIds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListWithIdsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountServer).ListWithIds(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/account.service.v1.Account/ListWithIds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServer).ListWithIds(ctx, req.(*ListWithIdsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Account_EmailLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EmailLoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountServer).EmailLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/account.service.v1.Account/EmailLogin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServer).EmailLogin(ctx, req.(*EmailLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Account_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListWithIds",
			Handler:    _Account_ListWithIds_Handler,
		},
		{
			MethodName: "EmailLogin",
			Handler:    _Account_EmailLogin_Handler,
		},
	},
